...
export default class travelController{
    ...
    async getAll(req,res,next){
        try {
            ...
            return res.render('admin/travel',{
    ...
    async addPage(req,res,next){
        try {
            return res.render('admin/addDestination',{
...
async add(req, res, next) {
    try {
        ...
        if (req.validationErrors) {
            return res.status(400).render("admin/addDestination", {
                title: "Add Travel Destination Page",
        ...
        return res.redirect("/api/admin/travel");
...
async updateDestinationPage(req,res,next){
            ...
            return res.render('admin/updateDestination',{
